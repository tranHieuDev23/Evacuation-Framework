...
namespace EvaFrame.Simulator.Hazards
{
    ...
    public class RandomCriticalHazard : IHazard
    {
        ...
        /// <summary>
        /// Khởi tạo một đối tượng <c>RandomCriticalHazard</c> mới, với thảm họa xảy ra ở một số tầng dưới cùng của tòa nhà.
        /// </summary>
        ...
        /// <summary>
        /// Khởi tạo một đối tượng <c>RandomCriticalHazard</c> mới, với thảm họa xảy ra ở một số được chỉ định cụ thể.
        /// </summary>
